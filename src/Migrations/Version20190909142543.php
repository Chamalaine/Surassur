 ...
 */
final class Version20190909142543 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE intermediaire (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(90) NOT NULL, password VARCHAR(900) NOT NULL, nom VARCHAR(60) NOT NULL, siret VARCHAR(30) DEFAULT NULL, date_creation DATETIME NOT NULL, roles JSON NOT NULL, numero VARCHAR(15) NOT NULL, libelle VARCHAR(50) NOT NULL, cp VARCHAR(20) NOT NULL, ville VARCHAR(20) NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, last_login DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
